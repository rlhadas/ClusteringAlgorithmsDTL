...
def k_means(graph, steps, k, seed=0, reps=None):
    ...
    # print "random %d %f %f" % (k,average,maximum) 
    print >> sys.stderr, '==========================='
    ...
    end_average, end_maximum = cluster_quality(graph, end_reps)
    # print "final  %d %f %f" % (k,average,maximum)
    print "%d %f %f" % (k,start_average,end_average),
    return end_reps
